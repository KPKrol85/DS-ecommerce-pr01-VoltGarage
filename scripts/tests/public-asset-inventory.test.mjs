...
// three formats the picture negotiates. Shop, collections and new arrivals have theirs; the rest
// are still on the placeholder, so these three families are the whole approved set until the next
// one lands.
...
const pageHeroFamilies = ['shop', 'category', 'new-arrivals'];
